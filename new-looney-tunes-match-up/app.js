        ...
        Panel.prototype.render = function (_butsOnTop) {
            ...
            switch(this.panelType) {
                ...
                case "start":
                    ...
                    ctx.drawImage(this.oTitleLogoImgData.img, 0, 0, this.oTitleLogoImgData.img.width, this.oTitleLogoImgData.img.height, canvas.width / 2 - (this.oTitleLogoImgData.img.width / 2) * tempScale, canvas.height * .3 - (this.oTitleLogoImgData.img.height / 2) * tempScale, this.oTitleLogoImgData.img.width * tempScale, this.oTitleLogoImgData.img.height * tempScale);
