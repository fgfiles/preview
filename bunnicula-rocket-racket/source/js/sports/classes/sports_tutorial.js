...
SportsTutorial.Rocket = function(){
    if (!CC.isMobile) {
        ...
        this.target.y = -125;
        this.hand = CC.Utility.pixiAtlasSprite("space_up.png");
        this.hand.x = -50;
        this.hand.y = 130;
        this.hand2 = CC.Utility.pixiAtlasSprite("space_down.png");
        this.hand2.x = -50;
        this.hand2.y = 130;
        ...
        // this.hand.gotoAndStop(Math.abs(Math.cos(value*Math.PI)) < 0.2);
            ...
            this.hand.visible = swingMotion === 0;
            this.hand2.visible = swingMotion > 0;
