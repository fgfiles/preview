...
TitleScreen = function() {
    ...
    BasicButton.apply(this.playAgainButton, function() {
        ...
        APP.controlOverlay ? APP.controlSelected ? APP.simpleApp.gotoScreen(APP.gameScreen) : PROFILE.canTilt ? (APP.controlSelected = !0, APP.controlOverlay.visible = !0, APP.controlOverlay.show(), APP.controlOverlay.onSelect = function() {
            ...
            APP.simpleApp.gotoScreen(APP.gameScreen)) : APP.simpleApp.gotoScreen(APP.gameScreen)
    }.bind(this));
    this.playAgainButton.disable();
    ...
    BasicButton.apply(this.productInfoButton, function() {
        ...
        window.open(PROFILE.mobile ? "http://m.your-website-name.co.uk/food_single_item.php?item_id\x3d11589" :
            "https://www.forestrygames.com", "_blank")
    });
    var a = document.createElement("div");
    a.className = "legals";
    a.innerHTML = "\x3cdiv style\x3d'margin-left:10px;'\x3eCopyright ©2019 - Forestry Games \x3ca style\x3d'color:#fae5be' href\x3d" +
        APP.tc + "\x3e\x3cu\x3eGame Ts \x26 Cs\x3c/u\x3e\x3c/a\x3e.\x3c/div\x3e";
...
GameoverScreen = function() {
    ...
    BasicButton.apply(this.productInfoButton, function() {
        _gaq.push(["_trackEvent", "Spicy mcbites", "Product Info clicks", "Product Info clicks"]);
        window.open(PROFILE.mobile ? "http://m.your-website-name.co.uk/food_single_item.php?item_id\x3d11589" : "https://www.forestrygames.com", "_blank")
    });
