...
(function (pixi_spine) {
    ...
    function atlasParser() {
        return function (resource, next) {
            ...
            var atlasPath = resource.url.substr(0, resource.url.lastIndexOf('.'))  + "@" + CC.ScaleFactor + "x" + metadataAtlasSuffix;
...
(function (pixi_spine) {
    ...
    var Spine = (function (_super) {
        ...
        Spine.prototype.createMesh = function (slot, attachment) {
            ...
            if(!this.blockPadding || CC.WebApp.current.renderer.type === 1)
            {
