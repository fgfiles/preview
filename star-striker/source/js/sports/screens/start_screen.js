...
Game.StartScreen.prototype.build = function () {
    ...
    this.background = CC.Utility.pixiAtlasSprite("splash_star_striker.png");
    ...
    this.title = SportsUI.createDisplayText(COPY_DECK.copy.game_names[5], {size: 25, maxSize: 130}, true);
