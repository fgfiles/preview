    ...
    function loadGFX()
    {
         ...
         manifest=[
            ...
            /*{id:'legal',src:'img/legal.png'},*/
             ...
             {id:'b8',src:'img/8.png'},
             {id:'b9',src:'img/9.png'},
             {id:'blank_1',src:'img/blank_1.png'},
             {id:'b0_1',src:'img/0_1.png'},
             {id:'b1_1',src:'img/1_1.png'},
             {id:'b2_1',src:'img/2_1.png'},
             {id:'b3_1',src:'img/3_1.png'},
             {id:'b4_1',src:'img/4_1.png'},
             {id:'b5_1',src:'img/5_1.png'},
             {id:'b6_1',src:'img/6_1.png'},
             {id:'b7_1',src:'img/7_1.png'},
             {id:'b8_1',src:'img/8_1.png'},
             {id:'b9_1',src:'img/9_1.png'}
