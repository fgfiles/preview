...
SkydiveGame.prototype.build = function () {
    ...
    this.movementAngle = 6;
    this.hand = CC.Utility.pixiAtlasSprite("hand_icon.png");
    this.hand.visible = false;
    this.addChild(this.hand);

    var angle = this.movementAngle*Math.TAU*0.25*1.7 + Math.PI;
...
SkydiveGame.prototype.update = function (delta) {
    ...
    if (CC.isMobile) {
        ...
        this.screenTo3D(this.hand.x, this.hand.y, this.playerZPosition- this.cameraPosition.z, this.playerControlTarget);
    }
