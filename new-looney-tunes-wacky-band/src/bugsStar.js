// JavaScript Document
class bugsStar extends Phaser.Group {
	...
	constructor(game,Button,Index) {
		...
		this.create(0, 0, 'earBugs',"bugs-ear (1)");
		this.children[1].x = 470 - this.children[1].width ;
		this.children[1].y = 0;
		this.children[1].animations.add('animation0',animation.generateFrameNames('bugs-ear (',1,14,')'));
		this.create(0, 0, 'headBugs');
		this.children[2] .x = (game.stage.width / 2) - (this.children[2].width)+20;
		this.children[2] .y = 500 - this.children[2].height;
		this.create(0, 0, 'HandBugs',"bugs-hand (1)");
		this.children[3].x = 230;
		this.children[3].y = 293;
		this.children[3].animations.add('animation0',animation.generateFrameNames('bugs-hand (',1,14,')'));
		...
		this.press = false;
		this.soundArray[0] = [game.add.audio('bugsStar0',1,false),false];
		this.soundArray[1] = [game.add.audio('bugsStar1',1,false),false];
		this.soundArray[2] = [game.add.audio('bugsStar2',1,false),false];
		this.soundArray[3] = [game.add.audio('bugsStar3',1,false),false];
		this.soundArray[4] = [game.add.audio('bugsStar4',1,false),false];
		this.visible = 0;
		this.x = 2000;
