var GBAPI = function()
{	
	this.targetFile = "https://highscores.disneyinternational.com/Scores.php";
	this.sharedKey = null;
...
GBAPI.prototype.sendScore = function(parameters, callBack)
{
	...
	var delim = " .|:=-=:|. ";
	var game = Aes.Ctr.encrypt(parameters.game, this.sharedKey, 256);
...
GBAPI.prototype.getScores = function(parameters, callBack)
{
	...
	parameters.orderAsc = parameters.orderAsc || this.orderAsc;
