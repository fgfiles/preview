    ...
    return function e(t, n, r) {
        ...
        1: [function(require, module, exports) {
            var MovieClip = require("./display/MovieClip"),
                ...
                Animator = function() {
                    this._particleSystems = null, this._emitters = null, this._movieClips = null, this._timers = null, this._tweens = null, this._paused = !1
                };
            module.exports = Animator, Animator.prototype.init = function() {
                ...
                } else if (a instanceof TweenMax && -1 != this._tweens.indexOf(a)) {
        ...
        6: [function(require, module, exports) {
            ...
            }, View.prototype.resize = function()
            {
                ...
                if (this.params.aspectRatioFillHeight)
                {
                    ratiow = width / this.params.width;
                    ratioh = this.params.height / height;

                    this.updateDimensions(Math.floor(this.params.width * ratiow * ratioh), this.params.height)
                }
                else
                {
                    ratiow = this.params.width / width;
                    ratioh = height / this.params.height;

                    this.updateDimensions(this.params.width, Math.floor(this.params.height * ratioh * ratiow));
                }
        ...
        8: [function(require, module, exports) {
            ...
            AudioManager.prototype.constructor = AudioManager, module.exports = AudioManager, AudioManager.instance = null, Object.defineProperty(AudioManager, "instance", {
                ...
                this._isMute = isMute, this.muteSFX(this._isMute), this.muteMusic(this._isMute), this.muteVO(this._isMute), isMute ? Howler.mute(true) : Howler.mute(false), this.signalMute.dispatch(this._isMute)
                ...
                for (var len = soundArray.length, i = 0; len > i; i += 1) {
                    ...
                    isMute ? sound.mute(true) : sound.mute(false)
                }
                ...
                this._isMute || Howler.mute(false)
        ...
        11: [function(require, module, exports) {
            function Button(normalTexture, overTexture, downTexture) {
                this.animate = !1, this.defaultScale = new PIXI.Point(1, 1), this.signals = {}, this.signals.down = new signals.Signal, this.signals.up = new signals.Signal, this.signals.over = new signals.Signal, this.signals.out = new signals.Signal, this.signals.click = new signals.Signal, this._normalTexture = normalTexture, this._overTexture = overTexture, this._downTexture = downTexture, this._tweenOver = null, this._tweenOut = null, PIXI.Sprite.call(this, this._normalTexture), this.anchor = new PIXI.Point(.5, .5), this.interactive = !0, this.buttonMode = !0, this.mousedown = this.touchstart = this.onMouseDown.bind(this), this.mouseup = this.touchend = this.onMouseUp.bind(this), this.mouseupoutside = this.touchendoutside = this.onMouseOut.bind(this), this.click = this.tap = this.onMouseClick.bind(this), this.mouseover = this.onMouseOver.bind(this), this.mouseout = this.onMouseOut.bind(this)
            }
            var Device = require("./../utils/Device");
            module.exports = Button, Button.prototype = Object.create(PIXI.Sprite.prototype), Button.prototype.constructor = Button, Button.prototype.init = function() {}, Button.prototype.dispose = function() {
                this.signals.up.dispose(), this.signals.down.dispose(), this.signals.over.dispose(), this.signals.out.dispose(), this.signals.click.dispose()
            }, Button.prototype.onMouseDown = function(event) {
                this.downTexture && (this.texture = this.downTexture), this.signals.down.dispatch(this, event)
            }, Button.prototype.onMouseUp = function(event) {
                this.overTexture && !p3.Device.isMobile ? this.texture = this.overTexture : this.texture = this.normalTexture, this.signals.up.dispatch(this, event)
            }, Button.prototype.onMouseOver = function(event) {
                if (this.overTexture && (this.texture = this.overTexture), this.animate && !Device.isMobile) {
                    var tweens = TweenMax.getTweensOf(this, !0),
                        count = tweens.indexOf(this._tweenOut) > -1 ? tweens.length - 1 : tweens.length;
                    count || (this._tweenOut && (this._tweenOut.kill(), this._tweenOut = null), this._tweenOver = this.animateOver())
                }
                this.signals.over.dispatch(this, event)
            }, Button.prototype.onMouseOut = function(event) {
                if (this.texture = this.normalTexture, this._tweenOver) {
                    var tweens = TweenMax.getTweensOf(this, !0),
                        count = tweens.indexOf(this._tweenOver) > -1 ? tweens.length - 1 : tweens.length;
                    tweens.length <= count && (this._tweenOver && (this._tweenOver.kill(), this._tweenOver = null), this._tweenOut = this.animateOut())
                }
                ...
                return TweenMax.to(this.scale, .8, {
                    x: 1.2 * this.defaultScale.x,
                    y: 1.2 * this.defaultScale.x,
        ...
        14: [function(require, module, exports) {
            function MuteButton(onNormalTexture, offNormalTexture, onOverTexture, offOverTexture, onDownTexture, offDownTexture) {
                ToggleButton.call(this, onNormalTexture, offNormalTexture, onOverTexture, offOverTexture, onDownTexture, offDownTexture)
            }
            var ToggleButton = require("./ToggleButton");
            module.exports = MuteButton, MuteButton.prototype = Object.create(ToggleButton.prototype), MuteButton.prototype.constructor = MuteButton, MuteButton.prototype.onMouseDown = function(event) {
                var audio = p3.AudioManager.instance;
                audio.mute(!audio.isMute), ToggleButton.prototype.onMouseDown.call(this, event)
        ...
        17: [function(require, module, exports) {
            ...
            module.exports = ParticleSystem, ParticleSystem.prototype = Object.create(PIXI.Container.prototype), ParticleSystem.prototype.constructor = ParticleSystem, ParticleSystem.VERSION = "3.0.0", ParticleSystem.EMITTER_TYPE_GRAVITY = 0, ParticleSystem.EMITTER_TYPE_RADIAL = 1, ParticleSystem.enabled = !0, ParticleSystem.prototype.start = function(duration) {
                ...
                if (ParticleSystem.enabled) {
                    ...
                    for (i = 0; i < this.maxCapacity; ++i) this._numParticles == this.capacity && this._raiseCapacity(this.capacity),
                        particle = this._particles[this._numParticles++], this._initParticle(particle)
                }
        ...
        25: [function(require, module, exports) {
            ...
            module.exports = Swipe, Swipe.prototype = Object.create(Transition.prototype), Swipe.prototype.constructor = Swipe
        }, {
            "./../ScreenManager": 20,
            "./Transition": 26
        }],
        ...
        37: [function(require, module, exports) {
            TrackingDataPlaydom = function() {
                this.tag = null
            }, module.exports = TrackingDataPlaydom, TrackingDataPlaydom.prototype.getUrlString = function() {
                return ""
            }
        }, {}],
        38: [function(require, module, exports) {
            ...
            module.exports = TrackingDataPlaydomDeviceInfo, TrackingDataPlaydomDeviceInfo.prototype = Object.create(TrackingDataPlaydom.prototype), TrackingDataPlaydomDeviceInfo.prototype.constructor = TrackingDataPlaydomDeviceInfo, TrackingDataPlaydomDeviceInfo.prototype.getUrlString = function() {
        ...
        39: [function(require, module, exports) {
            function TrackingDataPlaydomGameAction(context, action) {
                this.tag = "game_action", this.context = context, this.action = action
            }
            var TrackingDataPlaydom = require("./TrackingDataPlaydom");
            module.exports = TrackingDataPlaydomGameAction, TrackingDataPlaydomGameAction.prototype = Object.create(TrackingDataPlaydom.prototype), TrackingDataPlaydomGameAction.prototype.constructor = TrackingDataPlaydomGameAction, TrackingDataPlaydomGameAction.prototype.getUrlString = function() {
        ...
        40: [function(require, module, exports) {
            ...
            var TrackingDataPlaydom = require("./TrackingDataPlaydom");
            module.exports = TrackingDataPlaydomNavigationAction, TrackingDataPlaydomNavigationAction.prototype = Object.create(TrackingDataPlaydom.prototype), TrackingDataPlaydomNavigationAction.prototype.constructor = TrackingDataPlaydomNavigationAction, TrackingDataPlaydomNavigationAction.prototype.getUrlString = function() {
                return "tag=" + this.tag + "&context=" + this.context + "&action=" + this.action
            }
        }, {
            "./TrackingDataPlaydom": 37
        ...
        45: [function(require, module, exports) {
            ...
            module.exports = TrackingModulePlaydom, TrackingModulePlaydom.prototype.track = function(data) {
                var url = "https://api.disney.com/datatech/serverlog/v1/json",
                    params = "";
                params += "app=" + this._app + "&", params += "user_id=" + this._browserId + "&", params += "app_locale=" + this._appLocale + "&", params += "transaction_id=" + this._transactionId + "&", params += "browser_id=" + this._browserId + "&", params += "network=" + this._network + "&", params += "view_network=" + this._viewNetwork + "&", params += data.getUrlString();
        ...
        50: [function(require, module, exports) {
            ...
            module.exports = Camera, Camera.VERSION = "1.1.0", Camera.prototype.dispose = function() {
                ...
                var d = dx * dx + dy * dy;
                .1 > d && !this._tracking ? (this._tracking = !0, this.signalTrackingFinished.dispatch(this)) : d > .1 && this._tracking && (this._tracking = !1, this.signalTrackingStarted.dispatch(this)), this.updateLayers()
