...
Game.StartScreen.prototype.build = function () {
    ...
    this.background = CC.Utility.pixiAtlasSprite("splash_racket_rocket.png");
    ...
    this.title = SportsUI.createDisplayText(COPY_DECK.copy.game_names[3], {size: 25, maxSize: 130}, true);
