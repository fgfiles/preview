// This was copied from one where I modified this file from a build
...
window.boot = function () {
    ...
    function displayCanvasOnReady () {
        // Loading splash scene
		var canvas = document.getElementById('GameCanvas');
		var canvasDisplay = canvas.style.display;
