...
Game.StartScreen.prototype.build = function () {
    ...
    this.background = CC.Utility.pixiAtlasSprite("splash_sky_dive.png");
    ...
    this.title = SportsUI.createDisplayText(COPY_DECK.copy.game_names[4], {size: 25, maxSize: 130}, true);
