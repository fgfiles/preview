    ...
    var AssetLoader = (function () {
        function AssetLoader(_lang, _aFileData, _ctx, _canvasWidth, _canvasHeight, _showBar) {
            ...
            if(this.showBar) {
                ...
                this.logoY = 0;
                TweenLite.to(this, 1, {
                    bouncerY: canvas.height - 270 - this.oLoaderAssetsImgData.oData.oAtlasData[oImageIds.bouncer].height,
                    ease: "Cubic.easeIn",
                    onComplete: function () {
...
(function (Elements) {
    var Panel = (function () {
        function Panel(_panelType, _aButs) {
            ...
            this.oBrandLogoImgData = assetLib.getData("logo");
        ...
        Panel.prototype.render = function (_butsOnTop) {
            ...
            switch(this.panelType) {
                ...
                case "start":
                    ...
                    ctx.drawImage(this.oTitleLogoImgData.img, 0, 0, this.oTitleLogoImgData.img.width, this.oTitleLogoImgData.img.height, canvas.width / 2 - (this.oTitleLogoImgData.img.width / 2) * tempScale, canvas.height * .32 - (this.oTitleLogoImgData.img.height / 2) * tempScale, this.oTitleLogoImgData.img.width * tempScale, this.oTitleLogoImgData.img.height * tempScale);
                    tempScale = .5;
                    ctx.drawImage(this.oBrandLogoImgData.img, 0, 0, this.oBrandLogoImgData.img.width, this.oBrandLogoImgData.img.height, 20 + this.posY, canvas.height - 20 - (this.oBrandLogoImgData.img.height * tempScale), this.oBrandLogoImgData.img.width * tempScale, this.oBrandLogoImgData.img.height * tempScale);
                ...
                case "credits":
                    ...
                    ctx.fillRect(0, 0, canvas.width, canvas.height);
                    ctx.drawImage(this.oSplashLogoImgData.img, canvas.width / 2 - this.oSplashLogoImgData.img.width / 2, canvas.height / 2 - this.oSplashLogoImgData.img.height / 2 - this.posY);
                    addText(0, 20, 1000, "center", canvas.width / 2, canvas.height / 2 - 170 - this.posY, "producedFor", "#FFFFFF");
                    addText(0, 20, 1000, "center", canvas.width / 2, canvas.height / 2 + 90 - this.posY, "createdBy", "#FFFFFF");
                    break;
                case "gameOver":
                    this.flareRot += delta / 3;
                    ctx.save();
